...
SRC  = r"D:\claude_workspace\pov3d\zynq_pov\02_hello_zynq\vitis_ws\pov_boot_src"
...
# 删旧组件 (重跑幂等)
try:
    client.delete_component(name="pov_boot")
except Exception as e:
    print("no old comp:", e)

comp = client.create_app_component(name="pov_boot", platform=XPFM,
                                   domain="standalone_ps7_cortexa9_0",
                                   template="empty_application")
comp = client.get_component(name="pov_boot")
