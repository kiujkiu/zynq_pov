...
# 23 "pov_eta_rd.cpp" 2
# 1 "C:/Xilinx/Vitis/2024.2/common/technology/autopilot\\hls_burst_maxi.h" 1
# 17 "C:/Xilinx/Vitis/2024.2/common/technology/autopilot\\hls_burst_maxi.h"
# 1 "C:\\Xilinx\\Vitis\\2024.2\\win64\\tools\\clang-3.9-csynth\\lib\\clang\\7.0.0\\include\\stddef.h" 1 3
...
# 18 "C:/Xilinx/Vitis/2024.2/common/technology/autopilot\\hls_burst_maxi.h" 2
...
# 10 "C:/Xilinx/Vitis/2024.2/common/technology/autopilot\\ap_fixed.h"
...
# 20 "C:/Xilinx/Vitis/2024.2/common/technology/autopilot\\hls_burst_maxi.h" 2
...
__attribute__((sdx_kernel("pov_eta_rd", 0))) void pov_eta_rd(
...
#pragma HLSDIRECTIVE TOP name=pov_eta_rd
# 37 "pov_eta_rd.cpp"

#pragma HLS INTERFACE m_axi port=voxel offset=slave bundle=vox depth=1990656 max_read_burst_length=64 num_read_outstanding=8
...
#pragma HLS INTERFACE ap_ctrl_hs port=return
 ...
 int ns = n_slots;
    ...
    const int total_cols = ns * 192;
    const int total_beats = (total_cols + pf) * (216 / 4);
...
#pragma HLS LOOP_TRIPCOUNT min=10476 max=6252228
 ...
 const int k = i / (216 / 4);
        const int b = i - k * (216 / 4);

        if (b == 0 && k < total_cols) {
            const int s = k / 192;
            const int px = k - s * 192;
            int angle = ang0 + s;
            if (angle >= 603) angle -= 603;
            ...
            const unsigned src = ((unsigned)vz * 192 + (unsigned)vx) * (216 / 4);
            voxel.read_request(src, (216 / 4));
        }
