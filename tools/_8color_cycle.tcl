# 8 colors cycle: fill all 4 BRAMs with each color, snap, advance
connect
after 200
...
# 6-bit per channel max
# R=0x3F, G=0x3F00, B=0x3F0000, W=0x3F3F3F, Y=R+G=0x3F3F, M=R+B=0x3F003F, C=G+B=0x3F3F00, K=0
...
# Single color from command line arg (host loops)
