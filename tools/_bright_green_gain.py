...
import cv2,numpy as np; A=cv2.imread("tools/_green_gain_a.jpg").astype(int); B2=cv2.imread("tools/_green_gain_b.jpg").astype(int); print("freshness:",round(np.abs(A-B2).mean(),2))
img=cv2.imread('tools/_green_gain_b.jpg')
