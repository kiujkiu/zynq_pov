# Clear DAP sticky + dl bit + fill color
...
# Clear DAP sticky errors (write all 1 to ABORT register, addr 0x0 of DAP)
# Use jtag command 写 DPACC ABORT
catch { rst -dap }
after 200
...
# Re-clear DAP sticky after fpga load
catch { rst -dap }
after 200
