...
# 停 DMA → 灌 GLOBE 720 compact → sensor 配置重启
connect
after 500
...
after 300
puts "loading GLOBE 720 compact slices (5.76MB)..."
dow -data "D:/claude_workspace/pov3d/zynq_pov/tools/globe_slices_720_compact.bin" 0x18000000
...
after 500
puts "GLOBE sensor mode: CTRL=[format 0x%X [mrd -force -value 0x40020000]] DBG=[format 0x%08X [mrd -force -value 0x40020024]]"
exit 0
