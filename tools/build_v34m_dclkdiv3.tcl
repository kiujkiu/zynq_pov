# v34m build: DCLK_DIV 2→3 (75MHz/3 = 25MHz DCLK, 落回 FM6124 spec 30M 内)
...
puts "\[INFO\] DCLK_DIV 当前 = $old, 改为 3"
set_property CONFIG.DCLK_DIV {3} [get_bd_cells hub75e_panel_seq_0]
...
if {[string match "*write_bitstream Complete*" $imp_status]} {
    ...
    puts "\[INFO\] v34m (DCLK_DIV=3) xsa exported"
} else {
