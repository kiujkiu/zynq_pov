###############################################################################
# build_v8regen_recreate.tcl  (DRAFT 2026-06-11, 人工 review 后再跑)
#
# v7 BD recreate: hub75e_panel_seq_v6 -> v7 (1-bit compact frame, DMA 8KB/slice)
#   - 前提: hub75e_panel_seq_v8.v 已在 imports/hdl/ (module hub75e_panel_seq_v8)
...
#                     source ../tools/build_v8regen_recreate.tcl
###############################################################################
...
#------------------------------------------------------------------------------
set src_hub75e "D:/claude_workspace/pov3d/zynq_pov/02_hello_zynq/02_hello_zynq.srcs/sources_1/imports/hdl/hub75e_panel_seq_v8.v"
set xdc_hub75e "D:/claude_workspace/pov3d/zynq_pov/02_hello_zynq/02_hello_zynq.srcs/constrs_1/new/hub75e_pins.xdc"
if {[lsearch -exact [get_files -quiet] $src_hub75e] < 0} { add_files -norecurse $src_hub75e; puts "\[INFO\] added hub75e_panel_seq_v8.v" }
...
if {[llength [get_files -quiet -compile_order sources -used_in synthesis $src_hub75e]] == 0} {
    puts "\[WARN\] hub75e_panel_seq_v8.v not in compile order? 检查 module 名是否 hub75e_panel_seq_v8"
}
...
update_compile_order -fileset sources_1
create_bd_cell -type module -reference hub75e_panel_seq_v8 hub75e_panel_seq_0
set new_cell [get_bd_cells hub75e_panel_seq_0]
puts "\[INFO\] created new cell (ref hub75e_panel_seq_v8)"
...
#------------------------------------------------------------------------------
# 6. sensor_pulse 接 EXTERNAL PORT (v8: angle_tracker 已集成, 不再 xlconstant)
if {[get_bd_ports -quiet sensor_pulse] eq ""} { create_bd_port -dir I sensor_pulse }
connect_bd_net [get_bd_ports sensor_pulse] [get_bd_pins hub75e_panel_seq_0/sensor_pulse]
puts "\[INFO\] sensor_pulse -> external port (angle_tracker live)"
