###############################################################################
# 回滚 PS7 FCLK1 60M → 75M (复活 HDMI), 保留 verilog v28 overlap+OE_PRE + DCLK_DIV=2
# DCLK = 75/2 = 37.5 MHz (超 FM6124 spec 25% 但实测稳)
###############################################################################
...
puts "\[INFO\] setting PS7 FCLK1 = 75 MHz"
set_property -dict [list CONFIG.PCW_FPGA1_PERIPHERAL_FREQMHZ {75}] [get_bd_cells processing_system7_0]
