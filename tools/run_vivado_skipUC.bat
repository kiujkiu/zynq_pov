...
vivado.bat -mode batch -source D:\claude_workspace\pov3d\zynq_pov\tools\_vivado_build_skipUC.tcl -nojournal -nolog 1> D:\claude_workspace\pov3d\zynq_pov\tools\vivado_skipUC.log 2>&1
